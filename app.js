...
const sortbyABC = document.querySelector(".sortbyABC");
...
function displayData(data) {
  ...
  data.forEach((supplier) => {
    ...
    const idT = document.createElement("th");

    const companyT = document.createElement("td");
    const contactT = document.createElement("td");
    const cityT = document.createElement("td");

    idT.setAttribute("scope", "row");

    idT.textContent = supplier.id;
    companyT.textContent = supplier.companyName;
    contactT.textContent = supplier.contactName;
    cityT.textContent = supplier.address?.city;

    tr.append(idT, companyT, contactT, cityT);
...
window.onload = () => displayData(suppliers);
...
sortById.addEventListener("click", (e) => {
  e.preventDefault();
  const sorted = suppliers.sort((a, b) => a.id - b.id);

  displayData(sorted);
});

sortbyABC.addEventListener("click", (e) => {
  e.preventDefault();
